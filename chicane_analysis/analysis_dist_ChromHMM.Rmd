...
#[1] "unitary_pseudogene"     "IG_V_pseudogene"        "polymorphic_pseudogene" "misc_RNA"              
#[5] "rRNA_pseudogene"        "snoRNA"                 "TR_J_gene"              "TR_V_gene"
#removed pseudogene RNAs too to compare coding and non-coding directly
sig_res_rna_typ <-
  res_biotyp[q.value<0.05 & 
               !(gene_biotype_excl %in% c("unitary_pseudogene",
                                            "IG_V_pseudogene",
                                            "polymorphic_pseudogene","misc_RNA",
